...
export const transparencia = {
  ...
  files: [
    ...
    {
      name: "contratacion-suscrita",
      label: "Contratación Suscrita (convocatorias + suscritos)",
      file: "src/content/pages/transparencia/contratacion/contratacion-suscrita.json",
      fields: [
        { name: "title", label: "Título", widget: "string", required: true },
        { name: "description", label: "Descripción SEO", widget: "text", required: false },
        { name: "icon", label: "Icono FontAwesome", widget: "string", default: "fa-file-contract" },
        { name: "intro", label: "Texto introductorio", widget: "text", required: false },
        { name: "secopI", label: "URL SECOP I", widget: "string", required: false },
        { name: "secopII", label: "URL SECOP II", widget: "string", required: false },
        {
          name: "convocatorias",
          label: "Convocatorias a procesos públicos de selección",
          widget: "list",
          label_singular: "Categoría",
          collapsed: true,
          summary: "{{fields.categoria}}",
          fields: [
            { name: "categoria", label: "Categoría", widget: "string", required: true, hint: "Ej: Licitaciones Públicas, Selecciones Abreviadas, etc." },
            {
              name: "procesos",
              label: "Procesos",
              widget: "list",
              label_singular: "Proceso",
              collapsed: true,
              summary: "{{fields.label}}",
              fields: [
                { name: "label", label: "Identificador del proceso", widget: "string", required: true, hint: "Ej: ITRC-SASI-002-2026" },
                { name: "anio", label: "Año", widget: "string", required: false },
                { name: "pdfUrl", label: "URL aviso de convocatoria (PDF)", widget: "string", required: false },
                { name: "secopRef", label: "Referencia SECOP (CO1.NTC...)", widget: "string", required: false },
                {
                  name: "otros",
                  label: "Otros documentos asociados (resoluciones, adjudicación, etc.)",
                  widget: "list",
                  label_singular: "Documento",
                  collapsed: true,
                  required: false,
                  summary: "{{fields.label}}",
                  fields: [
                    { name: "label", label: "Título", widget: "string", required: true },
                    { name: "url", label: "URL", widget: "string", required: true },
                  ],
                },
              ],
        ...
        {
          name: "contratacionSuscrita",
          label: "Contratación suscrita por vigencia",
          widget: "list",
          ...
          fields: [
            ...
            {
              name: "contratos",
              label: "Contratos por periodo",
              widget: "list",
              label_singular: "Contrato",
              collapsed: true,
              summary: "{{fields.periodo}}",
              fields: [
                { name: "periodo", label: "Descripción / periodo", widget: "string", required: true },
                { name: "url", label: "URL del XLSX", widget: "string", required: true },
              ],
            },
          ],
        },
    ...
    })(),
    {
      ...
      fields: [
        ...
        },
        {
          ...
          widget: "list",
          collapsed: true,
          summary: "{{fields.year}} · {{fields.expediente}} · {{fields.titulo}}",
          fields: [
            { name: "id", label: "ID legacy (Joomla)", widget: "string", required: false, hint: "ID original en el sub-portal Joomla; sólo lectura" },
            { name: "year", label: "Año del expediente", widget: "string", required: false, pattern: ["^\\d{4}$|^$", "Año en formato AAAA o vacío"] },
            { name: "yearCategoria", label: "Categoría origen (Joomla)", widget: "string", required: false },
            { name: "instancia", label: "Instancia", widget: "select", options: ["", "primera", "segunda"], default: "" },
            { name: "expediente", label: "Expediente", widget: "string", required: false },
            { name: "titulo", label: "Título de la ficha", widget: "string", required: true },
            { name: "tamano", label: "Tamaño declarado", widget: "string", required: false, hint: "Ej: 149.22 KB" },
            { name: "filenameOrigen", label: "Filename original", widget: "string", required: false },
            { name: "slug", label: "Slug local", widget: "string", required: false },
            { name: "archivo", label: "Archivo PDF (cuando esté disponible)", widget: "file", required: false, hint: "Subir el PDF cuando jurídica lo provea" },
            { name: "origenUrl", label: "URL origen (auditoría)", widget: "string", required: false },
          ],
        },
      ],
    },
