...
export interface ApiMarcoLegalMarcoLegal extends Struct.SingleTypeSchema {
  collectionName: 'marco_legal';
  info: {
    description: 'P\u00E1gina de Marco Legal: secciones de documentos normativos + enlaces relacionados.';
    displayName: 'Marco Legal';
    pluralName: 'marco-legales';
    singularName: 'marco-legal';
  };
  options: {
  ...
  attributes: {
    ...
    icon: Schema.Attribute.String & Schema.Attribute.DefaultTo<'fa-landmark'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::marco-legal.marco-legal'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    secciones: Schema.Attribute.Component<'marco-legal.seccion', true>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::marco-legal.marco-legal': ApiMarcoLegalMarcoLegal;
